    ...
    <>
      ...
      <section className="py-32 bg-slate-50 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="bg-slate-900 rounded-[40px] p-10 md:p-14 border-4 border-slate-800 shadow-2xl relative overflow-hidden text-center">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed">
                  Com múltiplas fontes de receita acontecendo ao mesmo tempo. E tudo isso concentrado exclusivamente na sua cidade.
                </p>
                
                <div className="inline-flex flex-col items-center p-6 bg-slate-800/80 backdrop-blur border border-slate-700 rounded-3xl">
                  <p className="text-slate-200 font-bold text-lg mb-2">Quanto mais a plataforma cresce na sua região, mais essas fontes de receita se intensificam.</p>
                  <p className="text-emerald-400 font-extrabold text-xl">E você participa diretamente desse crescimento.</p>
                </div>
              </div>
            </div>
          </motion.div>
