                ...
                {category.services.map((service, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="w-[calc(50%-0.375rem)] sm:w-[160px] md:w-[180px] lg:w-[190px] flex-shrink-0 group bg-white p-4 md:p-6 rounded-[1.25rem] md:rounded-[1.5rem] border border-slate-100 shadow-sm hover:shadow-xl hover:border-[#2C47DD]/20 transition-all duration-300 relative cursor-default"
                    >
