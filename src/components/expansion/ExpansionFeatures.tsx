...
export function ExpansionFeatures() {
    ...
    <section className="py-32 bg-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div 
            whileHover={{ y: -5 }}
            className="p-10 md:p-12 bg-white rounded-[3rem] border border-slate-200/60 relative overflow-hidden group shadow-[0_15px_40px_-20px_rgba(0,0,0,0.05)]"
          >
            <div className="absolute top-0 right-0 p-12 opacity-5 scale-150 group-hover:opacity-10 transition-opacity">
              <Users className="w-48 h-48" />
            </div>
            <div className="w-16 h-16 bg-blue-50/50 rounded-2xl flex items-center justify-center mb-10 border border-blue-100/50">
              <Users className="w-8 h-8 text-primary" />
            </div>
            <p className="text-primary font-black text-xs uppercase tracking-[0.2em] mb-4">Solução B2C</p>
            <h3 className="text-3xl font-black mb-8 text-slate-900 tracking-tight">Para Clientes</h3>
            <ul className="space-y-6">
              {clientFeatures.map((f, i) => (
                <li key={i} className="flex items-start gap-4 text-slate-600 font-bold leading-snug">
          ...
          >
            ...
            <div className="w-16 h-16 bg-orange-50/50 rounded-2xl flex items-center justify-center mb-10 border border-orange-100/50">
              <HardHat className="w-8 h-8 text-orange-600" />
            </div>
            <p className="text-orange-600 font-black text-xs uppercase tracking-[0.2em] mb-4">Solução B2B</p>
            <h3 className="text-3xl font-black mb-8 text-slate-900 tracking-tight">Para Profissionais</h3>
            <ul className="space-y-6">
              {proFeatures.map((f, i) => (
                <li key={i} className="flex items-start gap-4 text-slate-600 font-bold leading-snug">
          ...
          <motion.div 
            whileHover={{ y: -5 }}
            className="p-10 md:p-12 bg-slate-900 rounded-[3rem] text-white relative overflow-hidden group shadow-2xl shadow-blue-900/10"
          >
            <div className="absolute top-0 right-0 p-12 opacity-10 scale-150 group-hover:opacity-20 transition-opacity">
            ...
            <p className="text-primary font-black text-xs uppercase tracking-[0.2em] mb-4">Gestão Regional</p>
            <h3 className="text-2xl md:text-3xl font-black mb-8 leading-tight tracking-tight">Tenha controle total da operação</h3>
            <ul className="space-y-6">
              {systemFeatures.map((f, i) => (
                <li key={i} className="flex items-start gap-4 text-slate-400 font-bold leading-snug">
...
export function ExpansionEarnings() {
