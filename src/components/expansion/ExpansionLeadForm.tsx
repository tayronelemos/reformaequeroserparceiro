...
export function ExpansionLeadForm() {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, i) => (
              <div 
                key={i} 
                className={`border rounded-[1.5rem] md:rounded-[2.5rem] transition-all duration-300 ${openIndex === i ? 'border-primary bg-primary/5 shadow-2xl shadow-primary/5' : 'border-slate-100 bg-slate-50 hover:bg-slate-100'}`}
              >
                <button
