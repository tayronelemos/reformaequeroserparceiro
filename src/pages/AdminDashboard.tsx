...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#FDFDFE] flex font-sans">
      {/* Sidebar */}
      <aside className="w-64 bg-white border-r border-slate-100 hidden lg:flex flex-col fixed inset-y-0 z-50">
        <div className="p-8">
          ...
          <nav className="space-y-1.5">
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl font-bold text-sm transition-all group ${activeView === 'dashboard' ? 'bg-primary/5 text-primary border border-primary/10 font-black' : 'text-slate-400 hover:bg-slate-50 hover:text-slate-700'}`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl font-bold text-sm transition-all group ${activeView === 'profissionais' ? 'bg-primary/5 text-primary border border-primary/10 font-black' : 'text-slate-400 hover:bg-slate-50 hover:text-slate-700'}`}
            >
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-2xl font-bold text-sm transition-all group ${activeView === 'settings' ? 'bg-primary/5 text-primary border border-primary/10 font-black' : 'text-slate-400 hover:bg-slate-50 hover:text-slate-700'}`}
            >
        ...
        <div className="mt-auto p-8 space-y-4">
          <div className="bg-slate-50 rounded-2xl p-4 border border-slate-100">
             ...
             <button className="w-full h-10 bg-white border border-slate-200 rounded-xl text-xs font-bold text-slate-600 hover:bg-slate-100 transition-all flex items-center justify-center gap-2">
        ...
        <header className="h-24 bg-white/80 backdrop-blur-md border-b border-slate-100 flex items-center justify-between px-8 sticky top-0 z-40">
          <div className="relative w-full max-w-md hidden md:block">
            ...
            <input 
              ...
              className="w-full h-12 pl-12 pr-4 bg-slate-50 border border-slate-100 rounded-xl text-sm font-medium focus:ring-4 focus:ring-primary/5 focus:border-primary/20 outline-none transition-all"
            />
          </div>
          ...
          <div className="flex items-center gap-4">
            <button 
              onClick={fetchLeads}
              disabled={loading}
              className="w-12 h-12 bg-white border border-slate-200 text-slate-400 rounded-xl flex items-center justify-center hover:text-primary transition-all active:scale-95 disabled:opacity-50"
            ...
            <button 
              onClick={exportCSV}
              className="px-6 h-12 bg-white border border-slate-200 text-slate-900 font-bold rounded-xl flex items-center gap-2 hover:bg-slate-50 transition-all text-sm active:scale-95"
            >
          ...
          {activeView === 'dashboard' && (
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-10">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                 <div className="lg:col-span-2 bg-white rounded-[2.5rem] p-8 border border-slate-100 flex flex-col">
                    <div className="flex items-center justify-between mb-8">
                       <div>
                          <h4 className="text-xl font-black text-slate-900 tracking-tight">Resumo Semanal</h4>
                       ...
                       <div className="flex bg-slate-50 p-1 rounded-xl gap-1">
                          {['7D', '30D'].map(period => (
                            <button 
                              ...
                              className={`px-4 py-1.5 rounded-lg text-[10px] font-black transition-all ${period === '7D' ? 'bg-white text-primary shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
                            >
                              {period}
                            </button>
                          ))}
                 ...
                 <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white relative overflow-hidden">
                    ...
                    <button onClick={() => setActiveView('profissionais')} className="mt-8 w-full py-4 bg-white text-slate-900 rounded-2xl font-black text-xs hover:bg-slate-100 transition-all">Ver todos Profissionais</button>
                 </div>
              </div>
            </motion.div>
          )}
